...
setTimeout((function() {
    'use strict';
    window.soundsToggleKey = "u"; //CHANGE THIS LETTER TO CHANGE THE KEYBOARD SHORTCUT TO TOGGLE THE SOUNDS.
    ...
    function updateGPWS() {
        ...
        if (typeof geofs.animation.values != 'undefined' && !geofs.isPaused()) {
            ...
            if (window.isAsOldAsYourMom && !window.wasAsOldAsYourMom) {
                ...
                window.apDisconnect = new Audio('https://github.com/ISA1716/GeoFS-GPWS-Alarms-and-Callouts/blob/main/Boeing%20Autopilot%20Disengage.mp3#:~:text=Raw-,View%20raw,-GeoFS%2DGPWS%2DAlarms');
